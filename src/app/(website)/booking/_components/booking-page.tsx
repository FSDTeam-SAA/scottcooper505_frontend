    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <Card className="p-6 border-border/50 shadow-sm">
          <h2 className="text-lg md:text-xl lg:text-2xl font-semibold text-black text-center leading-[120%] mb-2">
            Select Date
          </h2>
          <Calendar
        ...
        <div>
          {selectedDate && (
            <Card className="p-6 border-border/50 shadow-sm">
              ...
              <p className="text-base font-normal text-[#6B7280] leading-[120%] text-center mb-3 md:mb-6 lg:mb-8">Please select a date to view available time slots</p>
